  ...
  <div class="my-3 p-3 bg-body rounded shadow-sm">
    ...
    <div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('client.edite', ['client'=>$client->id]) }}" class="btn btn-outline-primary">Editer</a>
        ...
        <div class="btn-toolbar" style="display:inline-block; left: 8em;">
            ...
            <a href="{{ route('materiel.create') }}" class="btn btn-outline-primary">Ajouter un matériel</a>
        </div>
    </div>
  </div>
@endsection
